...
VERSION_MODULE_NAME:= github.com/mia-platform/vab/pkg/cmd
...
DESCRIPTION:= cli for managing the installation of day 2 operation tools on multiple kubernetes clusters
...
SOURCE_URL:= https://github.com/mia-platform/vab
BUILDX_CONTEXT?= vab-build-context
