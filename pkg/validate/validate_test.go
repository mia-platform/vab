...
[warn] no group found: check the config file if this behavior is unexpected
`
	expectedOutput3 = `[error][default] missing version of module group/module-1/flavor-1
[info][default] disabling module group/module-2/flavor-2
[error][default] missing version of add-on group/addon-1
[info][default] disabling add-on group/addon-2
